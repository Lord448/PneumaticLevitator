...
static result_t copyBufferData(osMemoryPoolId_t MemPoolID, void *src, void *dest, uint32_t size);
 ...
 * @note   This function needs to be called before the scheduler starts
 * @param  none
 * @retval none
 */
